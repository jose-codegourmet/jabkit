...
function BreadcrumbPage({ className, ...props }: BreadcrumbPageProps) {
  return (
    // biome-ignore lint/a11y/useFocusableInteractive: Current page is a non-focusable link per the shadcn breadcrumb.
    // biome-ignore lint/a11y/useSemanticElements: Current page uses role=link like the shadcn breadcrumb.
    <span
