...
Create a real heading and reading-measure hierarchy before selecting decorative assets. Remove unrelated badges, short marketing-line constraints, and decorative counters from source blocks. Adapt content1 or projects11 only after checking their anatomy; add captions beside figures in semantic markup. Keep Input labels and Button behavior while replacing visual defaults. A timeline must preserve DOM order when its desktop layout changes.
