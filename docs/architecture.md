...
| `apps/showcase/public/assets/design-systems/**` | No (Higgsfield MCP + local optimize) | **Committed** | Sample photography/illustration. Provenance JSON is hand-authored from real jobs. Not `sources.json`. |
