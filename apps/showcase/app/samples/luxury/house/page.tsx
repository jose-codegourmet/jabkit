...
export default function HousePage() {
  const house = sampleImage(
    "lux-house",
    "Placeholder entrance of a small lakeside house",
  );
  const portrait = sampleImage(
    "lux-host",
    "Placeholder portrait of Helen Mora, the fictional house keeper",
  );
  ...
  return (
    <main id="top">
      ...
      <Content1
        ...
        description="Practical context for a stay that does not exist outside this sample."
      ...
      <Faq12
        ...
        description="Access, guest counts, and the local inquiry. None of these answers invent a real certification."
