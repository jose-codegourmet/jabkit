...
export const brand = {
  ...
  intro:
    "Stillwater House is a fictional lakeside guest house for people who want a considered stay: a room they can compare, a few experiences on the grounds, and a local inquiry they can review without booking.",
} as const;
