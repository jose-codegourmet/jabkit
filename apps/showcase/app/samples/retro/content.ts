...
export const brand = {
  ...
  intro:
    "Pocket Keeps is a fictional creative utility for collecting small visual keepsakes and preparing a crop you can download in this browser. The studio works now. Plans describe a product idea, not an account you can open.",
} as const;
...
export const imageryStubNote =
  "Photography is a local vendor stub until RET-03. Jose owns the Higgsfield series via #260.";

export const provenanceNote =
  "These pictures stand in for a future Higgsfield series. They are existing showcase files, not licensed pack art, and they carry no commercial rights statement beyond this demo.";
...
export const keepAssets: KeepAsset[] = [
  {
    ...
    caption: "Desk Drawer. Matchbox still, stub photograph.",
  },
  {
    id: "drawer-ticket",
    collectionId: "desk-drawer",
    ...
    caption: "Desk Drawer. Torn ticket, stub photograph.",
  },
  {
    id: "postcard-pier",
    ...
    caption: "Weekend Postcards. Pier at low tide, stub photograph.",
  },
  {
    id: "postcard-kiosk",
    collectionId: "weekend-postcards",
    ...
    caption: "Weekend Postcards. Closed kiosk, stub photograph.",
  },
  {
    id: "bus-window",
    ...
    caption: "Night Bus. Window condensation, stub photograph.",
  },
  {
    id: "bus-ticket",
    collectionId: "night-bus",
    ...
    caption: "Night Bus. Night transfer, stub photograph.",
  },
];
...
export const collections: CollectionRecord[] = [
  {
    ...
    coverCaption: "Desk Drawer. Two stills, stub cover.",
  },
  {
    ...
    coverCaption: "Weekend Postcards. Pier still, stub cover.",
  },
  {
    id: "night-bus",
    slug: "night-bus",
    ...
    coverCaption: "Night Bus. Window still, stub cover.",
  },
];
