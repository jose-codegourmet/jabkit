    ...
    <header className={styles.header}>
      <div className={`${styles.frame} ${styles.headerInner}`}>
        <a className={styles.wordmark} href={sampleRoot}>
          <img
            src="/assets/design-systems/neo-brutalism/neo-logo-wordmark.webp"
            alt={brand.name}
        ...
        <Dialog>
          ...
          >
            <DialogHeader>
              <DialogTitle>Good Noise</DialogTitle>
      ...
      <div className={styles.frame}>
        <div className={styles.footerBrandRow}>
          <a href={sampleRoot} aria-label={brand.name}>
            <img
              src="/assets/design-systems/neo-brutalism/neo-logo-symbol.webp"
              alt=""
              width={64}
              height={64}
          ...
          <p className={styles.footerMotto}>Good work. Loud results.</p>
        </div>
