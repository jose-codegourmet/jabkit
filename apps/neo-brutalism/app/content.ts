...
export const brand = {
  ...
  intro:
    "We build identities and campaigns for independent places, people, and ideas. Clear thinking. Work with a point of view.",
} as const;
...
export const projects: ProjectRecord[] = [
  {
    ...
    captions: {
      object: "Common Ground. Studio object for the split-table mark. ",
      application:
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Ink is dense and the second color is reserved for the seam. The materials belong to this fictional identity study.",
        ],
      },
      {
        id: "applications",
  ...
  },
  {
    ...
    captions: {
      object: "Off Hours. Campaign object. ",
...
export const studioWorkplace = {
  ...
  paragraphs: [
    "Workshops happen around printed proofs, vinyl tests, and a shared checklist. Our process moves between a worktable, printed proofs, and production materials.",
